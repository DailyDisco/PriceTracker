    ...
    return (
        <div className='product-container'>
                ...
                <div className='flex-1 flex flex-col'>
                    <div className='flex justify-between items-start gap-5 flex-wrap pb-6'>
                        <div className='flex flex-col gap-3'>
                            ...
                            <Link
                                href={product.url} target='_blank' className='text-base text-black opacity-50'>
                                Visit Product
                            </Link>
                        </div>
                        <div className='flex items-center gap-3'>
                            ...
                            {/* bookmark icon */}
                            {/* add this bookmark functionality later */}
                            ...
                            {/* share icon */}
                            {/* add this share functionality later */}
                            <div className='p-2 bg-white-200 rounded-10'>
                                <Image
                    ...
                    <div className='product-info'>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            {/* add this recommendation % functionality later */}
            ...
            <div className='flex flex-col gap-16 mx-auto'>
                {/* <PriceHistoryChart data={[]} width={0} height={0} marginTop={0} marginRight={0} marginBottom={0} marginLeft={0} /> */}
                {/* <PriceHistoryChart /> */}
            </div>
            {/* Product Description */}
